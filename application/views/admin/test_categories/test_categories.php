...
<th><?php echo $this->lang->line('Order'); ?></th><th><?php echo $this->lang->line('Status'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
            ...
            <td>
                <?php echo $test_category->test_category; ?>
            </td>
            <td>
            ...
            ?>
                                ...
                                <td>
                                    <?php echo status($test_category->status,  $this->lang); ?>
                                    <?php
                                        ...
                                        if($test_category->status == 0){
                                            echo "<a href='".site_url(ADMIN_DIR."test_categories/publish/".$test_category->test_category_id."/".$page)."'> &nbsp;".$this->lang->line('Publish')."</a>";
                                        }elseif($test_category->status == 1){
                                            echo "<a href='".site_url(ADMIN_DIR."test_categories/draft/".$test_category->test_category_id."/".$page)."'> &nbsp;".$this->lang->line('Draft')."</a>";
                                        }
                                    ?>
                                </td>
                                <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."test_categories/view_test_category/".$test_category->test_category_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-edit" href="<?php echo site_url(ADMIN_DIR."test_categories/edit/".$test_category->test_category_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <a class="llink llink-trash" href="<?php echo site_url(ADMIN_DIR."test_categories/trash/".$test_category->test_category_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-trash-o"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
