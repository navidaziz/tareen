	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."test_types/update_data/$test_type->test_type_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("test_type_id", $test_type->test_type_id); ?>
                    ...
                    <?php 
                        foreach($test_categories as $test_category_id => $test_category){
                            ...
                            $data = array(
                                ...
                                "class"       => "uniform"
                                );if("$test_category_id" == $test_type->test_category_id){
                                    $data["checked"] = TRUE;
                                }
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("test_type", $test_type->test_type),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $textarea = array(
                        ...
                        "rows"          =>  "",
                        "cols"          =>  "",
                        "value"         => set_value("test_description", $test_type->test_description),
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    );  echo form_label($this->lang->line('image')."<br />".file_type(base_url("assets/uploads/".$test_type->image)), "image", $label);     ?>
                ...
                <?php
                    ...
                    $file = array(
                        ...
                        "value"         =>  set_value("image", $test_type->image),
                        "placeholder"   =>  $this->lang->line('image')
                    );
                    echo  form_input($file);
                ?>
                    <!--<?php echo file_type(base_url("assets/uploads/$test_type->image")); ?>-->
