	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."tests/update_data/$test->test_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("test_id", $test->test_id); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php
                    echo form_dropdown("test_category_id", $test_categories, $test->test_category_id, "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("test_name", $test->test_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $number = array(
                        ...
                        "value"         =>  set_value("test_time", $test->test_time),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $number = array(
                        ...
                        "value"         =>  set_value("test_price", $test->test_price),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $textarea = array(
                        ...
                        "rows"          =>  "",
                        "cols"          =>  "",
                        "value"         => set_value("test_description", $test->test_description),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("normal_values", $test->normal_values),
