	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."patient_tests/update_data/$patient_test->patient_test_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("patient_test_id", $patient_test->patient_test_id); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php
                    echo form_dropdown("invoice_id", $invoices, $patient_test->invoice_id, "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php
                    echo form_dropdown("test_id", $tests, $patient_test->test_id, "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("test_price", $patient_test->test_price),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("test_time", $patient_test->test_time),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("test_result", $patient_test->test_result),
