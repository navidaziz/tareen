...
<head>
  ...
  <script src="<?php echo site_url("assets/" . ADMIN_DIR . "ckeditor/ckeditor.js") ?>"></script>
        ...
        <div class="row">
          <div id="content" class="col-lg-12" style="padding: 0px !important; margin:0px !important;">
            ...
            <section id="page">
              ...
              ?>
                <div id="toast">
                  <div id="img"><i style="color:yellow" class="fa fa-exclamation-circle" aria-hidden="true"></i></div>
