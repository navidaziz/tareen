	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."suppliers/update_data/$supplier->supplier_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("supplier_id", $supplier->supplier_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("supplier_name", $supplier->supplier_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("supplier_contact_no", $supplier->supplier_contact_no),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("company_name", $supplier->company_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("account_number", $supplier->account_number),
