	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."expense_types/update_data/$expense_type->expense_type_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("expense_type_id", $expense_type->expense_type_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("expense_type", $expense_type->expense_type),
