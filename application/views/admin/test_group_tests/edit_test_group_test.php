	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."test_group_tests/update_data/$test_group_test->test_group_test_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("test_group_test_id", $test_group_test->test_group_test_id); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php
                    echo form_dropdown("test_id", $tests, $test_group_test->test_id, "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
