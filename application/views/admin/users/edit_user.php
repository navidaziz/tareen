        ...
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <label for="user_image" class="col-md-2 control-label" style=""></label>
                    <div class="col-md-10">
                        <div style="padding: 10px;">
                            <?php $test_group_ids = explode(",", $user->test_group_ids);
                            ?>
                            <?php
                            $query = "SELECT * FROM `test_groups` WHERE category_id=5";
                            $test_groups = $this->db->query($query)->result();
                            foreach ($test_groups as $test_group) { ?>
                                <input type="checkbox" name="test_group_id[]" value="<?php echo $test_group->test_group_id; ?>" <?php if (in_array($test_group->test_group_id, $test_group_ids)) { ?>checked<?php } ?> />
                            <?php echo $test_group->test_group_name . "<span style=\"margin:10px;\"></span> ";
                            }
