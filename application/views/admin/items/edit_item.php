    ...
    <div class="col-md-12">
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                echo form_open_multipart(ADMIN_DIR . "items/update_data/$item->item_id", $edit_form_attr);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "value"         =>  set_value("category", $item->category),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $textarea = array(
                            ...
                            "rows"          =>  "",
                            "cols"          =>  "",
                            "value"         => set_value("description", $item->description),
